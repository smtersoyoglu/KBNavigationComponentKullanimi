...
import com.sametersoyoglu.kbnavigationcomponentkullanimi.databinding.FragmentBottomSheetBinding


class BottomSheetFragment : BottomSheetDialogFragment() {
    // BottomSheetFragment yapmak için Fragment() yerine BottomSheetDialogFragment() olmak zorunda yoksa gösterme işlemlerini yapamayız.
